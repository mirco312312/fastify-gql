...
function createConnectionHandler ({ schema, subscriber, fastify, onConnect, lruGatewayResolvers, entityResolversFactory, subscriptionContextFn, keepAlive }) {
...
module.exports = function (fastify, opts, next) {
  const { getOptions, schema, subscriber, verifyClient, onConnect, lruGatewayResolvers, entityResolversFactory, subscriptionContextFn, keepAlive } = opts
