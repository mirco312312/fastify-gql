...
function createConnectionHandler ({ schema, subscriber, fastify, lruGatewayResolvers, entityResolversFactory, keepAlive }) {
...
module.exports = function (fastify, opts, next) {
  const { getOptions, schema, subscriber, verifyClient, lruGatewayResolvers, entityResolversFactory, keepAlive } = opts
