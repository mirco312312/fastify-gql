...
function createConnectionHandler ({ schema, subscriber, fastify, lruGatewayResolvers, entityResolversFactory, keepAlive, onConnect }) {
...
module.exports = function (fastify, opts, next) {
  const { getOptions, schema, subscriber, verifyClient, onConnect, lruGatewayResolvers, entityResolversFactory, keepAlive } = opts
